...
#This game will have three enemy objectives and one prize
#If snitch collides with the three enemies the game ends and the player loses
#If snitch collides with the anime character the game ends and the player wins
...
player = pygame.image.load("object.png")
...
enemyYPosition2 =  random.randint(10, screen_height - enemy2_height)
enemyXPosition3 =  screen_width
enemyYPosition3 =  random.randint(20, screen_height - enemy3_height)
